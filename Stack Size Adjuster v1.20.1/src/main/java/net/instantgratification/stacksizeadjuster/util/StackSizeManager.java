...
// Verified against: TagKey.java, ResourceLocation.java (1.20.1)
public class StackSizeManager {
    public static final TagKey<Item> C_STACK_SIZE_EXEMPT = TagKey.create(Registries.ITEM, new ResourceLocation("c", "stack_size_exempt"));
